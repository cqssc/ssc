...
namespace SSCService02
{
    public class Main
    {
        ...
        private static AllAnalysis_105 IAllAnalysis_103;


        //private static List<SpecialFuture_108> IListSpecialFuture_108;
        ...
        public void Start()
        {
            ...
            Task.Factory.StartNew(Task_Main);
            ICurrentLostAll_102 = new LostAll_102();
            IPreLostAll_102 = new LostAll_102();
            IAllAnalysis_103 = new AllAnalysis_105();
            ICurrentPeriod_101 = new PeriodDetail_101();
           // IListSpecialFuture_108 = new List<SpecialFuture_108>();
                ...
                if (IStrLastPeriod != 0)
                {
                    ...
                    if (listPeriodTemp_101 != null && listPeriodTemp_101.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            //取前面100期的数据
                            IListSingleAnalysis_103 = GetDataSingleAnalysis_103(100, IStrLastPeriod);
        ...
        /// <returns></returns>
        public List<PeriodDetail_101> GetListPeriodDetail_101(int AType, long PeriodNumber, long RecordNumber = -1)
        {
        ...
        /// <param name="?"></param>
        /// <returns></returns>
        public bool InitLostAll_102(int AType, List<PeriodDetail_101> AListPeriod_101, ref LostAll_102 ALostAll_102)
        {
        ...
        /// <returns></returns>
        public bool InitSingleAnalysis103(int AType, List<PeriodDetail_101> AListPeriod_101) 
        {
            bool flag = true;
            ...
            for (int i = 1; i <= 5;i++ ) //1位到5位
            {
                ...
                singTemp.IsSpanOne_040 = 0;
                singTemp.IsTwoConRepick_041 = 0;
                singTemp.IsThreeConRepick_042 = 0;
                singTemp.IsFourPile_043 = 0;
                singTemp.IsFivePile_044 = 0;
                singTemp.IsTread_045 = 0;
                singTemp.TreadDetail_046 = 0;
                singTemp.IsTreadAddOne_047 = 0;
                singTemp.TreadAddOneDetail_048 = 0;
                singTemp.IsTreadAddTwo_049 = 0;
                    ...
                    case 1: //正常统计
                        {
                            ...
                            if(AListPeriod_101.Count>=5)
                            {
                                ...
                                {                                    
                                    ...
                                    if (continueCount >= 3)
                                    {
                                        singTemp.SmallConDetail_031 = 1;
                                        singTemp.IsEvenCon_032 = continueCount;
                                    }
                                }
                                ...
                                if (listSingleAnalysis_103Temp != null && listSingleAnalysis_103Temp.Count >= 3)
                                {
                                    ...
                                    if (continueCount>=3)
                                    {
                                        singTemp.IsFourPile_043 = 1;
                                        if (continueCount >= 4)
                                        {
                                            singTemp.IsFivePile_044 = 1;
                                        }
                                    }
                                }
                                #endregion
                                ...
                                if (continueCount >=2)
                                {
                                    singTemp.IsTread_045 = 1;
                                    singTemp.TreadDetail_046 = continueCount;
                                }
                                ...
                                if (continueCount >= 2)
                                {
                                    singTemp.IsTreadAddOne_047 = 1;
                                    singTemp.TreadAddOneDetail_048 = continueCount;
                                }
            ...
            if (ListSpecialFuture108Temp.Count>0 && UpdateOrADDSpecialFuture_108(ListSpecialFuture108Temp, 1))
            {
        ...
        //得到某位上某数在0-9的数量上的排序
        public int GetSingValueOrder(int WeiType, List<PeriodDetail_101> AlistPeriodDetail,int APositionValue) 
        {
            int order = 0;
            List<int> listAllNumCount = new List<int>();
            int count = 0;
        ...
        //取103表当前统计期前面的数据
        public List<SingleAnalysis_103> GetDataSingleAnalysis_103(int ACount, long APeriod) 
        {
            ...
            try
            {
                ...
                foreach (SingleAnalysis_103 ss in AListSingleAnalysis) 
                {
                    ...
                    if (drCurrent != null) //更新
                    {
                        ...
                        drCurrent["C040"] = ss.IsSpanOne_040;
                        drCurrent["C041"] = ss.IsTwoConRepick_041;
                        drCurrent["C042"] = ss.IsThreeConRepick_042;
                        drCurrent["C043"] = ss.IsFourPile_043;
                        drCurrent["C044"] = ss.IsFivePile_044;
                        drCurrent["C045"] = ss.IsTread_045;
                        drCurrent["C046"] = ss.TreadDetail_046;
                        drCurrent["C047"] = ss.IsTreadAddOne_047;
                        drCurrent["C048"] = ss.TreadAddOneDetail_048;
                        drCurrent["C049"] = ss.IsTreadAddTwo_049;
                    ...
                    else //添加新行
                    {
                        ...
                        drNewRow["C040"] = ss.IsSpanOne_040;
                        drNewRow["C041"] = ss.IsTwoConRepick_041;
                        drNewRow["C042"] = ss.IsThreeConRepick_042;
                        drNewRow["C043"] = ss.IsFourPile_043;
                        drNewRow["C044"] = ss.IsFivePile_044;
                        drNewRow["C045"] = ss.IsTread_045;
                        drNewRow["C046"] = ss.TreadDetail_046;
                        drNewRow["C047"] = ss.IsTreadAddOne_047;
                        drNewRow["C048"] = ss.TreadAddOneDetail_048;
                        drNewRow["C049"] = ss.IsTreadAddTwo_049;
        ...
        {           
            ...
            for (int i = 1; i <= 5; i++) //1位到5位
            {
                        ...
                        case 6://F_Three20InSingle, 单位单双遗失大于20以上3期内打出
                            {
                                ...
                                if (sf.PositionVale_003 % 2 == 1)
                                {
                                    ...
                                    if (listSingleNumValue[0] % 2 == 1)
                                    {
                                        ...
                                        else if (GetSpanOfTwoPeriod59(AListPeriod_101[0].LongPeriod_001, sf.LongPeriod_001) >= 3)
                                        {
                                            sf.IsComplete_005 = 1;
                                            sf.IsScore_006 = 0;
                                            sf.ScoreLongPeriod_008 = AListPeriod_101[0].LongPeriod_001;
                ...
                #region  //写数据
                {
                    ...
                    if (UpdateOrADDSpecialFuture_108(listSfTemp, 0))
                    {
        ...
        public bool Task_Set_102()
        {
            Logger.Info("我是Thread02，我开始干活啦");


            return true;
        }

        public bool Task_Worker_03()
        {
            Logger.Info("我是Thread03，我开始干活啦");

            return true;
        }

        public bool Task_Worker_04()
        {
            Logger.Info("我是Thread03，我开始干活啦");
            return true;
        }
